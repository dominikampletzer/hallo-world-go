...
func (s *server) GetUUID(ctx context.Context, request *helloworld.UUIDRequest) (*helloworld.UUIDReply, error) {
	uuid = atomic.AddInt64(&uuid, 1)
	return &helloworld.UUIDReply{Uuid: uuid}, nil
}
